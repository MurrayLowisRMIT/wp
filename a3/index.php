            ...
            <main>
                <article class="foreword">
                    <div class="articleHeader">
                        <a class="floatRight" href="#1">Next</a>
                ...
                <article>
                    ...
                    <div class="postcard">
                        <div>placeholder postcard cover text</div>
                        <div>
                ...
                <article>
                    ...
                    <div class="letter">
                        <div>placeholder letter cover text</div>
                        <div>
                            <p class="right">May 4th. 1915
                            </p><p>Dear Mother,
